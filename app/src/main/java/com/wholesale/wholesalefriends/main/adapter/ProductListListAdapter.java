...
public class ProductListListAdapter extends RecyclerView.Adapter<ProductListListAdapter.ViewHolder> {
    ...
    public ProductListListAdapter(Context context, ArrayList<ProductListData> data) {
        ctx = context;
    ...
    public ProductListListAdapter(Context context, RequestManager manager, ArrayList<ProductListData> data) {
        ctx = context;
        inflater = LayoutInflater.from(ctx);
        arrayList = data;
