...
public class HomeMain02ListAdapter extends RecyclerView.Adapter<HomeMain02ListAdapter.ViewHolder> {
    ...
    public interface AdapterListener {
        ...
        void onClickItem(BestProductListData data,int pos);
    }
    ...
    public HomeMain02ListAdapter(Context context, ArrayList<BestProductListData> data) {
        ctx = context;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        BestProductListData data = arrayList.get(position);
       if (data!=null){
    ...
    public BestProductListData getItem(int position) {
    ...
    public List<BestProductListData> getItems() {
        return arrayList;
    }

    public void add(BestProductListData item, int position) {
        arrayList.add(position, item);
        notifyDataSetChanged();
    }

    public void addAll(List<BestProductListData> items) {
    ...
    public void remove(BestProductListData item) {
        int position = arrayList.indexOf(item);
        arrayList.remove(item);
        notifyDataSetChanged();
    }

    public void set(int pos, BestProductListData item) {
