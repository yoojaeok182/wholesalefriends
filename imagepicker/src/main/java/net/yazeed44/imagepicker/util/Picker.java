...
public final class Picker {
    ...
    public interface PickListener {
        void onPickedSuccessfully(final ArrayList<ImageEntry> images, boolean isEdit);

        void onCancel(boolean isCamera);
    ...
    public static class Builder {
        ...
        public Picker.Builder setCamera(final boolean isCamera) {
            mCamera = isCamera;
            return this;
        }
