...
public class TransformImageView extends ImageView {
    ...
    /**
     * Setter for {@link #mMaxBitmapSize} values.
    ...
    /**
     * @return - current image scale values.
    ...
    /**
     * This method calculates scale values for given Matrix object.
     */
    ...
    /**
     * This method returns Matrix values for given index.
     *
     * @param matrix     - valid Matrix object
     * @param valueIndex - index of needed values. See {@link Matrix#MSCALE_X} and others.
     * @return - matrix values for index
     */
