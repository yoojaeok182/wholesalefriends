...
public class GestureCropImageView extends CropImageView {
    ...
    /**
     * This method calculates target scale values for double tap gesture.
     * User is able to zoom the image from min scale values
     * to the max scale values with {@link #mDoubleTapScaleSteps} double taps.
     */
