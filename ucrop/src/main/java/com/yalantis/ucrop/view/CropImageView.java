...
public class CropImageView extends TransformImageView {
    ...
    /**
     * @return - maximum scale values for current image and crop ratio
     */
    ...
    /**
     * @return - minimum scale values for current image and crop ratio
     */
     ...
     * If {@link #SOURCE_IMAGE_ASPECT_RATIO} values is passed - aspect ratio is calculated
    ...
    public void setImageToWrapCropBoundsAnimDuration(@IntRange(from = 100) long imageToWrapCropBoundsAnimDuration) {
        if (imageToWrapCropBoundsAnimDuration > 0) {
            ...
            throw new IllegalArgumentException("Animation duration cannot be negative values.");
        }
    }
    ...
    /**
     * This method scales image down for given values related to image center.
     */
    ...
    /**
     * This method scales image down for given values related given coords (x, y).
     */
    ...
    /**
     * This method scales image up for given values related to image center.
     */
    ...
    /**
     * This method scales image up for given values related to given coords (x, y).
     */
    ...
    /**
     * This method changes image scale for given values related to point (px, py) but only if
     * resulting scale is in min/max bounds.
     *
     * @param deltaScale - scale values
     ...
     * Scale values must be calculated only if image won't fill the crop bounds after it's translated to the
