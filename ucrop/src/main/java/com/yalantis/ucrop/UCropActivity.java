...
//    private View mBlockingView;
    ...
    private RelativeLayout btnClose, btnRotate,btnDone;
    private ImageView ivRotate, ivDone;
    ...
    private void setupAppBar() {
        ...
        llayoutToolbar = findViewById(R.id.llayoutToolbar);
...
//        llayoutToolbar.setBackgroundColor(mToolbarColor);

//        tvToolbarTitle.setTextColor(mToolbarWidgetColor);
  ...
  /*      Drawable stateButtonDrawable = ContextCompat.getDrawable(this, mToolbarCancelDrawable).mutate();
        ...
        ivDone.setColorFilter(mToolbarWidgetColor, PorterDuff.Mode.SRC_ATOP);
        ivRotate.setColorFilter(mToolbarWidgetColor, PorterDuff.Mode.SRC_ATOP);*/
